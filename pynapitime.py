...
parser.add_argument('-m','--match', help="specify number of subtitles sorted by duration diff, default 0 (best match)", action="store", type=int, default=0)
...
if __name__ == "__main__":
    ...
    if video.check_for_subs() and not args.overwrite:
        ...
        print('Choosed %s best match which differ from your video %s ms.' % (args.match + 1,chosen_subs['duration_diff']))
